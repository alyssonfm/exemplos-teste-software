 ...
 */
public int numberOfDays(int m, int a)
{
   if (isLeap(a) && m == 2)
      return 29;
   if ( a == 1752 && m == 9 )
 ...
 * 
 * @param dds: Esse parâmetro indica em que dia da semana cai o dia 1 do mês
 * cujo calendário se quer calcular. Deve ser uma valor entre 0 e 6.
 * @param n: Indica quantos dias tem o mês. Pode ser um valor entre 28 e 31
 ...
 */
public String cal(int dds, int n)
{
  if ( n == 19 )
 ...
 * @param yr: o ano que se deseja computar o dia da semana.
 * @return: um valor entre 0 e 6 que indica o dia da semana do primeirio
 * dia do ano.
 */
public int jan1(int yr)
{
  int y, d;
